...
const SHOW = {
  ...
  corners: [
    ...
    {
      title: "二人で討論！「闘論ファイター」",
      image: "assets/corner-touron.png",
      desc: "毎回お題を決めて2人が本気で討論するコーナー。ただし負けても命までは取られません、健康にされるだけです。通算5敗した方には罰ゲームとして運動や食事制限などの”健康化ミッション”が科されます。普段いかに不健康な生活をしているかがバレる、ある意味リスナー参加型ヘルスケア企画。",
    },
    {
      title: "ラジオレター大募集",
